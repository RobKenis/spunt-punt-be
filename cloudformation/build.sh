...
mv elastictranscoder.zip "$WORKING_DIRECTORY/output/code/"
...
mv start_encode.zip "$WORKING_DIRECTORY/output/code/"
...
mv request_encoding.zip "$WORKING_DIRECTORY/output/code/"
...
mv update_encoding_state.zip "$WORKING_DIRECTORY/output/code/"
...
mv rekognition.zip "$WORKING_DIRECTORY/output/code/"
...
mv video_metadata_event.zip "$WORKING_DIRECTORY/output/code/"
...
mv rekognition_results.zip "$WORKING_DIRECTORY/output/code/"
